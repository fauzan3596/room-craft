...
const AboutPage = () => {
  return (
    <div>
      <div className="bg-gradient-to-r from-purple-100 via-blue-100 to-pink-100 text-center py-16 px-6">
        ...
        <p className="text-lg text-gray-600 mt-4">
          ...
          design platform. Create, customize, and visualize your perfect space.
        </p>
      </div>
